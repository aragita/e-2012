				...
				<tr>
					...
					<table border="0" width="100%" cellspacing="1" id="table4">
						...
						<tr>
							...
							<p style="margin: 3px 10px">
							<font face="Tahoma" size="2" color="#000080">Jumlah keuangan</font></td>
						</tr>
						<?
...
while($d=mysql_fetch_array($query)){
    $siswa=mysql_fetch_array(mysql_query("SELECT sum(biaya_daftar) FROM  `data_siswa` WHERE `jurusan` = '$d[kode]'"));
?>
                        <tr>
							<td width="270" valign="top" bgcolor="#DDE9F7">
							<p style="margin: 3px 10px">
