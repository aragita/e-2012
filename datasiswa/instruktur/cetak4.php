...
<div id="cetak" style="text-align: center">
	<table border="0" width="614" cellspacing="0" cellpadding="0" id="table1">
		...
		<tr>
			...
			<font size="4">Daftar Siswa Aktif</font></p>
			<p class="MsoTitle" align="center" style="margin-top: 1px; margin-bottom: 1px">
			...
			<table border="0" width="99%" cellspacing="0" cellpadding="0" id="table5">
				<tr>
					<td width="46" align="center" style="border: 1px solid #000000" bgcolor="#EAEAEA">
					<b>No.</b></td>
					<td width="83" align="center" style="border-right: 1px solid #000000; border-top: 1px solid #000000; border-bottom: 1px solid #000000" bgcolor="#EAEAEA">
					<b>No Induk</b></td>
					<td width="160" align="center" style="border-right: 1px solid #000000; border-top: 1px solid #000000; border-bottom: 1px solid #000000" bgcolor="#EAEAEA">
					<b>Nama</b></td>
					<td align="center" style="border-right: 1px solid #000000; border-top: 1px solid #000000; border-bottom: 1px solid #000000" bgcolor="#EAEAEA">
					<b>Alamat</b></td>
				...
				<?
					...
					<td width=\"83\" style=\"border-right: 1px solid #000000; border-bottom: 1px solid #000000\">
					<p style=\"margin-left: 2px; margin-right: 2px\">
					<font size=\"2\">&nbsp;$d[induk]</font></td>
					<td width=\"160\" style=\"border-right: 1px solid #000000; border-bottom: 1px solid #000000\">
					<p style=\"margin-left: 2px; margin-right: 2px\">
