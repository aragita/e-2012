		...
		<tr>
			...
			<table border="0" width="100%" cellspacing="0" cellpadding="0" id="table3">
				<tr><span class=menu>
                    ...
                    if($level=="1"){
                        ?>
                        SISTEM INFORMASI MANAGEMEN DATA SISWA MADCOMS
                        <? }else{ ?>
                        <font size="2"><a href="diploma.php?menu=data.siswa">SISWA</a>
					    <b>|</b> <a href="diploma.php?menu=data.materi">MATERI</a>
					<b>|</b> <a href="diploma.php?menu=data.jurusan">JURUSAN</a>
					<b>|</b> <a href="diploma.php?menu=data.kelas">DATA KELAS</a>
					<b>|</b> <a href="diploma.php?menu=data.absensi">DATA ABSENSI</a>
					<b>|</b> <a href="diploma.php?menu=data.nilai">DATA NILAI</a>
					<b>|</b> <a href="diploma.php?menu=data.administrasi">ADMINISTRASI</a>
					<b>|</b> <a href="diploma.php?menu=data.instruktur">INSTRUKTUR</a>
                    <? } ?></font></td></span>
				</tr>
			</table>
			</td>
...
<?
if(isset($menu)){
    include"./diploma/$menu.php";
}else{
    include"./diploma/data.siswa.php";
}
?>
                <tr>
			<td colspan="3" valign="top">
